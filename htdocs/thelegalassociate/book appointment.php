      ...
      <section class="form-container">
         ...
         <form action="send.php" method="post">
            <h3>Book Appointment !</h3>
             ...
             <select id="query" name="subject">   
                <option value="GST Registration">Subject For Appointment</option>
             ...
             <input type="text" name="address" required maxlength="50" placeholder="Enter your Address" class="box">
             <input type="text" name="mobile" required maxlength="50" placeholder="Enter your Mobile No." class="box">



             <input type="email" name="email" required maxlength="50" placeholder="Enter your email" class="box">
            
             <input type="date" name="date" required maxlength="50" placeholder="dd-mm-yy" class="box">
           ...
           <!---- <select id="query">   
            ...
            <p>Free Advice With Us? <a href="free advice.html">Free Advice</a></p>
...
try {
    ...
    $mail->addAddress('ethelegalassociate0@gmail.com', 'The Legal Associate');     //Add a recipient
    ...
    $mail->Body    = "Sender Subject - $subject <b>Sender Name - $name <b>Sender Address - $address <b>Sender Mobile - $mobile <b>Sender Email - $email <b>Sender Date - $date";
